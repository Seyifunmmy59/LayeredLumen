...
CREATE TABLE `order` (
  ...
  PRIMARY KEY (`orderId`),
  KEY `cId` (`cId`),
  CONSTRAINT `order_ibfk_1` FOREIGN KEY (`cId`) REFERENCES `customer` (`CustId`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orderdetail` (
  ...
  KEY `FK01_idx` (`ItemCode`),
  CONSTRAINT `FK01` FOREIGN KEY (`ItemCode`) REFERENCES `item` (`ItemCode`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK02` FOREIGN KEY (`OrderId`) REFERENCES `order` (`orderId`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-03-29 20:37:17
